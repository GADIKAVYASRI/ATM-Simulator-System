...
public class SignUpOne extends JFrame implements ActionListener {
    ...
    JButton next;
    JRadioButton male,female,married,unmarried,other,oth;
    ...
    SignUpOne(){
        ...
        JLabel PersonDetails =new JLabel("1.PERSONAL DETAILS: ");
        PersonDetails.setFont(new Font("Raleway",Font.BOLD,25));
        PersonDetails.setBounds(290,80,350,30);
        add(PersonDetails);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        String dob = ((JTextField) dateChooser.getDateEditor().getUiComponent()).getText();//UIComponent returns textField.
        String gender=null;
        if(male.isSelected())
        {
            gender="Male";
